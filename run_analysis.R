...
#------------------------------------------------------------------------------
	...
	rm(fileUrl,x_train, y_train,subject_train,x_test, y_test,subject_test,tidyDataSet)
	...
	write.table(tidy_data, file="./data/UCI HAR Dataset/tidy_dataset.txt", sep="\t", row.names=FALSE) 
